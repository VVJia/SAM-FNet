...
if __name__ == '__main__':
    # dataset = Synapse_dataset('/home/fanxm/pro/SAMed/datasets/train_npz_new_224/', '/home/fanxm/pro/SAMed/lists/lists_Synapse/', 'train',
    #                        transform=transforms.Compose(
    #                            [RandomGenerator(output_size=[224, 224], low_res=[56, 56])]))

    # dataset = Synapse_dataset('/home/fanxm/pro/SAMed/datasets/train_npz_new_224/',
    #                           '/home/fanxm/pro/SAMed/lists/lists_Synapse/', 'train')


    # dataset = COCO_dataset('/home/fanxm/pro/datasets/coco/val/', '/home/fanxm/pro/datasets/coco/annotations/cancer_val.json',
    #                        split="val", transform=transforms.Compose(
    #                             [RandomGenerator(output_size=[224, 224], low_res=[56, 56])]))

    dataset = Cancer_dataset("/home/user/pro/DLGNet/datasets/segment", "/home/user/pro/SAM/SAMed_h/datasets/val.txt",
                             transform=transforms.Compose(
                                                             [RandomGenerator(output_size=[224, 224], low_res=[56, 56])]))
    print(dataset[1]['image'].shape)
    print(dataset[1]['label'].shape)
    print(dataset[1]['case_name'])
    ...
    # print(dataset[100]['image'].shape)
    # print(dataset[100]['low_res_label'].shape)
    # plt.imshow(dataset[100]['low_res_label'])
    # plt.show()
    # plt.imshow(np.rollaxis(dataset[100]['image'].cpu().numpy(), 0, 3))
    # plt.show()
    #
    # print(dataset[3]['image'])
    # data_item = iter(dataset)
